...
-- BTN	=>  Location: PIN_B8,	 I/O Standard: 3.3 V Schmitt Trigger,	 Current Strength: Default


ARCHITECTURE structure OF vk2mux IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \Mux0~0_combout\ = (\BTN~input_o\ & (\SW[1]~input_o\)) # (!\BTN~input_o\ & ((\SW[0]~input_o\)))
